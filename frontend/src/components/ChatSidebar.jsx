...
const ChatSidebar = ({
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="fixed inset-y-0 left-0 z-50 w-[260px] h-full shadow-2xl"
          >
            <div className="w-full h-full flex flex-col bg-white/40 backdrop-blur-md border-r border-white/20 shadow-sm">
              {/* Sidebar Header */}
              <div
                className="flex items-center justify-between px-4 py-3 border-b border-white/20 shadow-sm"
              ...
              {/* Account Section */}
              <div
                className="border-t border-white/20 px-3 py-4"
                style={{
                  minHeight: "86px",
                  display: "flex",
                  alignItems: "center",
                  ...
                  <AnimatePresence>
                    {showAccountMenu && (
                      <motion.div
                        ...
                        className="absolute bottom-full left-0 right-0 mb-2 bg-white/80 backdrop-blur-xl rounded-xl shadow-lg border border-white/40 overflow-hidden"
                      >
      ...
      {/* No more collapsed toggle button here */}
    </>
  );
};
