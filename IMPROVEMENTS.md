...
- [x] **Rủi ro lưu dữ liệu (Data Loss):** Chuyển đổi để Backend là nguồn lưu/cập nhật cuối cùng tự động (khi nhận prompt và trả response) thay vì chờ React gọi hàm qua `setTimeout`.
